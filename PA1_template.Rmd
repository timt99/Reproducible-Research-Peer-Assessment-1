...
```{r Histogram1, fig.width= 7,fig.height=6, echo=TRUE}
...
##  Step 8. Number of missing values: `r NA_activity`
...
## MeanImputed:   `r MeanNewStepsbyDay`
## MedianImputed: `r MedianNewStepsbyDay`
...
```{r, panelplot, fig.height=4, echo= TRUE}
